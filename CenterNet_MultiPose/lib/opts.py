...
class opts(object):
  def __init__(self):
    ...
    # ../Live_demo_20200117/video/000010.mp4
    self.parser.add_argument('--demo', default='H:/project/git_project/RGB_HandPose/Cascade_Inference/vedio/1.mp4',
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')
    self.parser.add_argument('--load_model', default='./exp/multi_pose/default_resnet_50/model_last.pth',
    ...
    self.parser.add_argument('--no_color_aug', action='store_true',
                             help='not use the color augmenation '
                                  'from CornerNet')
    # multi_pose
    self.parser.add_argument('--aug_rot', type=float, default=0.1,
  ...
  def parse(self, args=''):
    ...
    opt.data_dir = 'I:/project/yolact/data/coco2017'
