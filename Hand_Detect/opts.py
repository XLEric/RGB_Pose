...
class opts(object):
  def __init__(self):
    ...
    # model
    self.parser.add_argument('--arch', default='res_18',  # default='dla_34',
    ...
    self.parser.add_argument('--lr_step', type=str, default='190,220',
    ...
    # dataset
    self.parser.add_argument("--data_dir", type=str, default="../../data/coco")
